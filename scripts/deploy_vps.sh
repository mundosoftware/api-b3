...
AI_OUTLOOK_WORKER_ENABLED="${AI_OUTLOOK_WORKER_ENABLED:-true}"
AI_OUTLOOK_WORKER_POLL_SECONDS="${AI_OUTLOOK_WORKER_POLL_SECONDS:-2}"
AI_OUTLOOK_JOB_MAX_ATTEMPTS="${AI_OUTLOOK_JOB_MAX_ATTEMPTS:-3}"
AI_OUTLOOK_RETRY_DELAY_SECONDS="${AI_OUTLOOK_RETRY_DELAY_SECONDS:-15}"
...
CLEANUP_FILES+=("${TMP_ENV}")
{
  ...
  write_env_line "AI_OUTLOOK_WORKER_ENABLED" "${AI_OUTLOOK_WORKER_ENABLED}"
  write_env_line "AI_OUTLOOK_WORKER_POLL_SECONDS" "${AI_OUTLOOK_WORKER_POLL_SECONDS}"
  write_env_line "AI_OUTLOOK_JOB_MAX_ATTEMPTS" "${AI_OUTLOOK_JOB_MAX_ATTEMPTS}"
  write_env_line "AI_OUTLOOK_RETRY_DELAY_SECONDS" "${AI_OUTLOOK_RETRY_DELAY_SECONDS}"
